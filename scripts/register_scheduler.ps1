...
function Register-BatTask {
    ...
    $settings  = New-ScheduledTaskSettingsSet `
                     ...
                     -StartWhenAvailable  $true `   # run once when laptop wakes after missing a trigger
                     -WakeToRun           $false `   # do NOT wake the laptop just for this
                     -MultipleInstances   IgnoreNew  # never stack two runs on top of each other
