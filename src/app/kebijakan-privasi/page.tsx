      ...
      <main className="max-w-3xl mx-auto px-4 py-10 space-y-6">
        ...
        <div className="bg-white rounded-xl border border-stone-200 p-6 space-y-5 text-sm text-stone-700 leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <p>
              IDXDaily mengumpulkan data yang sangat minimal dan tidak bersifat pribadi:
            </p>
          ...
          <section className="space-y-2">
            ...
            <p>
              IDXDaily tidak memiliki sistem akun pengguna. Kami tidak mengumpulkan nama, alamat
          ...
          <section className="space-y-2">
            ...
            <p>
              IDXDaily menggunakan Google AdSense untuk menampilkan iklan. Google AdSense dapat
