...
export const metadata: Metadata = {
  title: 'Kebijakan Privasi - DailyIHSG',
  description: 'Kebijakan privasi DailyIHSG: data apa yang dikumpulkan dan bagaimana penggunaannya.',
};
      ...
      <main className="max-w-3xl mx-auto px-4 py-10 space-y-6">
        ...
        <div className="bg-white rounded-xl border border-stone-200 p-6 space-y-5 text-sm text-stone-700 leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <p>
              DailyIHSG mengumpulkan data yang sangat minimal dan tidak bersifat pribadi:
            </p>
          ...
          <section className="space-y-2">
            ...
            <p>
              DailyIHSG tidak memiliki sistem akun pengguna. Kami tidak mengumpulkan nama, alamat
          ...
          <section className="space-y-2">
            ...
            <p>
              DailyIHSG menggunakan Google AdSense untuk menampilkan iklan. Google AdSense dapat
