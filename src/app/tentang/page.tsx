...
export const metadata: Metadata = {
  title: 'Tentang DailyIHSG',
  description: 'Apa itu DailyIHSG, bagaimana cara kerjanya, dan dari mana datanya.',
};
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      <main className="max-w-3xl mx-auto px-4 py-10 space-y-6">
        <h1 className="text-2xl font-bold text-[#0f172a]">Tentang DailyIHSG</h1>

        <div className="bg-white rounded-xl border border-stone-200 p-6 space-y-4 text-sm text-stone-700 leading-relaxed">
          <h2 className="font-semibold text-base text-[#0f172a]">Apa itu DailyIHSG?</h2>
          <p>
            DailyIHSG adalah agregator berita dan sentimen pasar saham Indonesia. Kami mengumpulkan
          ...
          <p>
            Indeks Fear &amp; Greed DailyIHSG dihitung setiap hari dari dua komponen utama:
          </p>
          ...
          <p className="text-xs text-stone-500 border-t border-stone-100 pt-4">
            DailyIHSG bukan penasihat investasi. Seluruh informasi di situs ini bersifat edukatif
